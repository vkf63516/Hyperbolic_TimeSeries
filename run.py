...
parser.add_argument('--root_path', type=str, default='time-series-dataset/dataset/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='weather.csv', help='data file')
parser.add_argument("--manifold_type", type=str, default="Poincare", help="use either Poincare, or Euclidean")
