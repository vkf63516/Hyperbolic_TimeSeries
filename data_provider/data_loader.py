...
class Dataset_Custom_Decomposition(Dataset):
    """
    Custom dataset with orthogonalMSTL decomposition. This is for visual analysis, not for model running.
    This helps provide interpretability and justifications for our research approach.
    """
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='ETTh1.csv',
                 target='OT', scale=True, timeenc=0, freq='h', 
