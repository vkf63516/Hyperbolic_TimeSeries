...
hyperbolic_weights=(0.1 0.2)
hierarchy_weights=(0.05 0.1 0.01)
learning_rates=(1e-2 1e-3 1e-4 1e-1)
...
echo "Starting hyperparameter tuning for ETTm2 dataset"
            ...
            for lr in "${learning_rates[@]}"; do
                for win_size in "${window_sizes[@]}"; do
                    ...
                    python -u run.py \
                      ...
                      --model_id ETTm2_${seq_len}_${pred_len}_${manifold_type}_HP_h${hyp_weight}_hi${hier_weight}_lr${lr}_w${win_size} \
                      ...
                      --use_moving_window \
                      --result_file ETTm2_pred${pred_len}_hyperparam_results.csv
