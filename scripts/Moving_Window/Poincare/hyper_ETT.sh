...
echo "Starting hyperparameter tuning for ETTm1 dataset"
            ...
            for lr in "${learning_rates[@]}"; do
                for win_size in "${window_sizes[@]}"; do
                    ...
                    python -u run.py \
                      ...
                      --model_id ETTm1_${seq_len}_${pred_len}_${manifold_type}_HP_h${hyp_weight}_hi${hier_weight}_lr${lr}_w${win_size} \
		      ...
		      --mstl_period 48 \
                      ...
                      --use_moving_window \
                      --result_file ETTm1_pred${pred_len}_hyperparam_results.csv
