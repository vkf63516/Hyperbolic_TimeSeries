...
class HybridPoincare(nn.Module):
    """
    Hybrid encoder: One component in Poincaré ball, others in Euclidean.
    ...
    def __init__(self, lookback, input_dim, embed_dim=32, hidden_dim=64, 
        ...
        # Poincaré ball manifold for hyperbolic component
        self.manifold = geoopt.manifolds.PoincareBall(c=curvature)
    ...
    def forward(self, trend, seasonal_coarse, seasonal_fine, residual):
        ...
        Returns:
            dict with:
                ...
                - hyperbolic_point: [B, embed_dim] (only for hyperbolic component)
